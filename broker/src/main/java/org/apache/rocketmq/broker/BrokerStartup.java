...
public class BrokerStartup {
    ...
    public static BrokerController createBrokerController(String[] args) {
        ...
        if (null == System
                .getProperty(NettySystemConfig.COM_ROCKETMQ_REMOTING_SOCKET_RCVBUF_SIZE)) {
                ...
                public void run() {
                    synchronized (this) {
                        ...
                        if (!this.hasShutdown) {
                            ...
                            log.info("Shutdown hook over, consuming total time(ms): {}",
                                    consumingTimeTotal);
                        }
                    }
                }
    ...
    private static void properties2SystemEnv(Properties properties) {
        ...
        String rmqAddressServerDomain = properties.getProperty("rmqAddressServerDomain",
                MixAll.WS_DOMAIN_NAME);
        String rmqAddressServerSubGroup = properties.getProperty("rmqAddressServerSubGroup",
