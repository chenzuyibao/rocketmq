...
public class BrokerStartup {
    ...
    public static BrokerController start(BrokerController controller) {
        try {
            ...
            String tip =
                "The broker[" + controller.getBrokerConfig().getBrokerName() + ", " + controller.getBrokerAddr()
    ...
    public static BrokerController createBrokerController(String[] args) {
        ...
        try {
            ...
            // 构造命令行解析Options, 这个过程已经设置了h(help)、n(namesrvAddr)两个参数, 后面还会配置c(configFile), p(printConfigItem),
            // m(printImportantConfig)；parseCmdLine()方法会对mqbroker启动命令进行解析
            ...
            nettyClientConfig.setUseTLS(Boolean.parseBoolean(
                System.getProperty(TLS_ENABLE, String.valueOf(TlsSystemConfig.tlsMode == TlsMode.ENFORCING))));
            ...
            // 设置当前broker的角色(master,slave), 如果是同步/异步MASTER信息，brokerId=0 ;如果是SLAVE信息，brokerId > 0 ; 如果brokerId < 0 ,
            // 会抛出异常
